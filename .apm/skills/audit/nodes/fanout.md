...
Stash the full ledger as a JSON array via `.../skills/runbook/runbook-driver --workflow=audit set findings '<json-array>'`. The **done** node writes the final `.audit-results.json` including this ledger.
