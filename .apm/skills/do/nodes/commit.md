...
```
.../skills/vcs/vcs-op commit "<conventional message>"
.../skills/vcs/vcs-op push <branch-name>          # -u semantics on first push
```
...
**Verify**: `.../skills/vcs/vcs-op log-head` shows a new commit on the feature branch, and it's pushed to remote.
